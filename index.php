...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if($results->num_rows == 1) {
        ...
        if(password_verify($password, $admin['password'])) {                  //$admin['password'] === $password pre je ovo bilo u zagradi dok nije dosao momenat za hashovanje sifre.
            $_SESSION['admin_id'] = $admin['admin'];    // ovde smo u sesiji sacuvali admin_id, to je zbog zastite ulaska na admin_dashboard i ovo pored je admin koji smo koristili gore vec tu su nam i sifra i sve.
